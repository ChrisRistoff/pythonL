...
def add_resources(resource_list, resource_choice, resource_quan) :
    ...
    while resource_choice != "water" and resource_choice != "milk" and resource_choice != "coffee" and resource_choice!= "money":
        resource_choice = input("Which resource would you like to update?\nWater, milk, coffee or money?")
    while resource_quan == "":
        try:
            resource_quan = int(input(f"How much {resource_choice} would you like to add or use - if you would like to remove?\n"))
...
def choice_prompt(choice, resource) :
    ...
    while choice != "espresso" and choice != "latte" and choice!= "cappuccino" and choice!= "report" and choice!= "exit":
        choice = input("Choose a drink from the list:\n Espresso,Latte, Cappuccino \n").lower()
        if choice == "report" :
            ...
            if resource == "no":
                ...
                resource = ""
                continue
            else : return add_resources(resources, "", "")
    return choice
