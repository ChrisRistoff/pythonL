class CoffeeMachine:
    ...
    def add_resources(self, resource_choice, resource_quan):
        """prompts the user to pick a resource to add and
        ...
        while resource_quan == "":
            try:
                resource_quan = int(
                    input(
                        f"How much {resource_choice} would you like to add"
                        + "or use - if you would like to remove?\n"
                    )
                )
        ...
        print(f"You have {self.resources[resource_choice]}"
              + f"{resource_choice} left")
    ...
    def insert_coin_prompt(self, choice, quarters, dimes, nickles, pennies):
        ...
        while quarters == "" or dimes == "" or nickles == "" or pennies == "":
            try:
                ...
                dimes = int(input("How many dimes would"
                                  + "you like to insert? : "))
                nickles = int(input("How many nickles would"
                                    + "you like to insert? : "))
                pennies = int(input("How many pennies would"
                                    + "you like to insert? : "))
            except ValueError or TypeError:
